...
const sqlGet = 'select ' + 
               '    sum(tempodominio.tempo) as tempo, ' +
               '    tempodominio.dominio ' +
               'from ' +
               '    tempodominio ' +
               'where ' +
...
// http://localhost:12005/api/registros/tempodominio/
// https://joaozucchinalighislandi.com.br/api/registros/tempodominio/
